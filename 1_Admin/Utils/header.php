<header>
	...
	<nav class="navbar navbar-expand-lg navbar-light" id="nav_nav">
		<a class="navbar-brand" href="?controller=home&action=home"><img src="Content/img/logo_detoure.png" alt=""
				width="3%" class="img_logo_nav">
			ByteMaster
		</a>
			...
			<ul class="navbar-nav ml-auto">
				...
				<li class="nav-item dropdown">
					...
					<div class="dropdown-menu" aria-labelledby="navbarDropdown">
						...
						<a class="dropdown-item" href="?controller=crud&action=crud">C.R.U.D</a>
						<a class="dropdown-item" href="../?controller=login_signup&action=logout"
