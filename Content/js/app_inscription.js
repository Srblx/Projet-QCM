...
document.addEventListener("DOMContentLoaded", function() {
  ...
  form.addEventListener("submit", function(event) {
    ...
    if (nom === "") {
      ...
      document.querySelector(".error-message-nom").textContent = "Le nom doit avoir entre 2 et 30 caractères";
      isValid = false;
    }
    ...
    if (prenom === "") {
      ...
      document.querySelector(".error-message-prenom").textContent = "Le prénom doit avoir entre 2 et 30 caractères";
      isValid = false;
    }
    ...
    if (email === "") {
      ...
      document.querySelector(".error-message-email").textContent = "Le format de l'email est invalide";
      isValid = false;
    }
    ...
    if (password === "") {
      ...
      document.querySelector(".error-message-password").textContent = "Le mot de passe doit contenir au moins 12 caractères avec une majuscule, une minuscule, un chiffre et un caractère spécial";
      isValid = false;
    }
    ...
    if (confirmPassword === "") {
      ...
      document.querySelector(".error-message-cpassword").textContent = "Le mot de passe ne correspond pas";
      isValid = false;
    }

    if (!checkBox.checked) {
      document.querySelector(".error-message-checkbox").textContent = "Veuillez accepter les conditions générales d'utilisation";
      isValid = false;
    }
